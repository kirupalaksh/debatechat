...
/**
 * A URL factory for the debatechat.
 *
...
use mod_debatechat\local\entities\author as author_entity;
...
class url {
    ...
    /**
     * Get the course url from the given debatechat entity.
     *
     * @param debatechat_entity $debatechat The debatechat entity
     * @return moodle_url
     */
    public function get_course_url_from_debatechat(debatechat_entity $debatechat) : moodle_url {
        return $this->get_course_url_from_courseid($debatechat->get_course_id());
    }

    /**
     * Get the create discussion url for the given debatechat.
     *
     * @param debatechat_entity $debatechat The debatechat entity
     * @return moodle_url
     */
    public function get_discussion_create_url(debatechat_entity $debatechat) : moodle_url {
        return new moodle_url('/mod/debatechat/post.php', [
            'debatechat' => $debatechat->get_id(),
        ]);
    }

    /**
     * Get the view debatechat url for the given debatechat and optionally a page number.
     *
     * @param debatechat_entity $debatechat The debatechat entity
     ...
     * @return moodle_url
     */
    public function get_debatechat_view_url_from_debatechat(debatechat_entity $debatechat, ?int $pageno = null,
            ?int $sortorder = null) : moodle_url {

        return $this->get_debatechat_view_url_from_course_module_id($debatechat->get_course_module_record()->id, $pageno, $sortorder);
    }

    /**
     * Get the view debatechat url for the given course module id and optionally a page number.
     *
     ...
     * @return moodle_url
     */
    public function get_debatechat_view_url_from_course_module_id(int $coursemoduleid, ?int $pageno = null,
            ?int $sortorder = null) : moodle_url {

        $url = new moodle_url('/mod/debatechat/view.php', [
            'id' => $coursemoduleid,
        ]);
    ...
    public function get_discussion_view_url_from_discussion_id(int $discussionid) : moodle_url {
        return new moodle_url('/mod/debatechat/discuss.php', [
            'd' => $discussionid
        ]);
    }
     ...
     *
     * @param debatechat_entity $debatechat The debatechat the post belongs to
     * @param post_entity $post The post
     * @return moodle_url
     */
    public function get_edit_post_url_from_post(debatechat_entity $debatechat, post_entity $post) : moodle_url {
        if ($debatechat->get_type() == 'single' && !$post->has_parent()) {
            return new moodle_url('/course/modedit.php', [
                'update' => $debatechat->get_course_module_record()->id,
                'sesskey' => sesskey(),
                'return' => 1
            ]);
        } else {
    ...
    public function get_reply_to_post_url_from_post(post_entity $post) : moodle_url {
        return new moodle_url('/mod/debatechat/post.php#mformdebatechat', [
            'reply' => $post->get_id()
        ]);
    }
    ...
    public function get_export_post_url_from_post(post_entity $post) : ?moodle_url {
        ...
        $button->set_callback_options('debatechat_portfolio_caller', ['postid' => $post->get_id()], 'mod_debatechat');
     ...
     *
     * @param post_entity $post The post
     * @param int $displaymode The display mode to show the debatechat in after marking as read
     * @return moodle_url
     */
    public function get_mark_post_as_read_url_from_post(post_entity $post, int $displaymode = FORUM_MODE_THREADED) : moodle_url {
        ...
        $url = new moodle_url('/mod/debatechat/discuss.php', $params);
     ...
     *
     * @param post_entity $post The post
     * @param int $displaymode The display mode to show the debatechat in after marking as unread
     * @return moodle_url
     */
     ...
     *
     * @param debatechat_entity $debatechat The debatechat that the discussion belongs to
     * @param discussion_entity $discussion The discussion
     * @return moodle_url
     */
    public function get_mark_discussion_as_read_url_from_discussion(
        ...
        return new moodle_url('/mod/debatechat/markposts.php', [
            'f' => $discussion->get_debatechat_id(),
            'd' => $discussion->get_id(),
            'mark' => 'read',
            'sesskey' => sesskey(),
            'return' => $this->get_debatechat_view_url_from_debatechat($debatechat)->out(),
        ]);
    }
     ...
     * @return moodle_url
     */
    public function get_mark_all_discussions_as_read_url(debatechat_entity $debatechat) : moodle_url {
        return new moodle_url('/mod/debatechat/markposts.php', [
            'f' => $debatechat->get_id(),
            'mark' => 'read',
            'sesskey' => sesskey(),
    ...
    public function get_discussion_subscribe_url(discussion_entity $discussion) : moodle_url {
        return new moodle_url('/mod/debatechat/subscribe.php', [
            'sesskey' => sesskey(),
            'id' => $discussion->get_debatechat_id(),
            'd' => $discussion->get_id()
        ]);
    }
