...
use mod_debatechat\local\entities\discussion_summary as discussion_summary_entity;
...
use mod_debatechat\local\entities\sorter as sorter_entity;
use stdClass;
use context;
use cm_info;
use user_picture;
...
/**
 * Entity factory to create the debatechat entities.
 *
 * See:
...
class entity {
    /**
     * Create a debatechat entity from a stdClass (legacy debatechat object).
     *
     * @param stdClass $record The debatechat record
     * @param context $context The debatechat module context
     * @param stdClass $coursemodule Course module record for the debatechat
     * @param stdClass $course Course the debatechat belongs to
     * @return debatechat_entity
     */
    public function get_debatechat_from_stdclass(
        stdClass $record,
        context $context,
        ...
        return new debatechat_entity(
            ...
            $record->scale,
            $record->grade_debatechat,
            $record->grade_debatechat_notify,
            $record->maxbytes,
