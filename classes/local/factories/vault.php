...
use mod_debatechat\local\vaults\author as author_vault;
use mod_debatechat\local\vaults\discussion as discussion_vault;
use mod_debatechat\local\vaults\discussion_list as discussion_list_vault;
use mod_debatechat\local\vaults\debatechat as debatechat_vault;
use mod_debatechat\local\vaults\post as post_vault;
use mod_debatechat\local\vaults\post_attachment as post_attachment_vault;
use mod_debatechat\local\vaults\post_read_receipt_collection as post_read_receipt_collection_vault;
use file_storage;
use moodle_database;
...
class vault {
    ...
    /**
     * Create a debatechat vault.
     *
     * @return debatechat_vault
     */
    public function get_debatechat_vault() : debatechat_vault {
        return new debatechat_vault(
            $this->db,
            $this->entityfactory,
            $this->legacymapper->get_legacy_data_mapper_for_vault('debatechat')
        );
    }
     ...
     */
    public function get_discussions_in_debatechat_vault() : discussion_list_vault {
