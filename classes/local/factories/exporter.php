...
use mod_debatechat\local\entities\post_read_receipt_collection as post_read_receipt_collection_entity;
...
use mod_debatechat\local\exporters\debatechat as debatechat_exporter;
use mod_debatechat\local\exporters\discussion as discussion_exporter;
use mod_debatechat\local\exporters\discussion_summaries as discussion_summaries_exporter;
use mod_debatechat\local\exporters\post as post_exporter;
use mod_debatechat\local\exporters\posts as posts_exporter;
use context;
use rating;
use stdClass;
...
class exporter {
    ...
    /**
     * Construct a new debatechat exporter for the specified user and debatechat.
     *
     * @param   stdClass        $user The user viewing the debatechat
     * @param   debatechat_entity    $debatechat The debatechat being viewed
     * @param   int             $currentgroup The group currently being viewed
     * @return  debatechat_exporter
     */
    public function get_debatechat_exporter(
        stdClass $user,
        debatechat_entity $debatechat,
        ?int $currentgroup
    ) : debatechat_exporter {
        return new debatechat_exporter($debatechat, [
    ...
    /**
     * Fetch the structure of the debatechat exporter.
     *
     * @return  array
     */
    public static function get_debatechat_export_structure() : array {
        return debatechat_exporter::read_properties_definition();
    }

    /**
     * Construct a new discussion exporter for the specified user and debatechat discussion.
     *
     * @param   stdClass          $user The user viewing the debatechat
     * @param   debatechat_entity      $debatechat The debatechat being viewed
     * @param   discussion_entity $discussion The discussion being viewed
     * @param   stdClass[]        $groupsbyid The list of groups in the debatechat
    ...
    public function get_discussion_exporter(
        ...
        return new discussion_exporter($discussion, [
            'context' => $debatechat->get_context(),
            'debatechat' => $debatechat,
            'capabilitymanager' => $this->managerfactory->get_capability_manager($debatechat),
            'urlfactory' => $this->urlfactory,
            'user' => $user,
            'legacydatamapperfactory' => $this->legacydatamapperfactory,
     ...
     * @param   stdClass[]      $groupsbyid The set of groups in the debatechat in an associative array for each group
