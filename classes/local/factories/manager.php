...
use mod_debatechat\local\managers\capability as capability_manager;
use rating_manager;
...
class manager {
    ...
    /**
     * Create a capability manager for the given debatechat.
     *
     * @param debatechat_entity $debatechat The debatechat to manage capabilities for
     * @return capability_manager
     */
    public function get_capability_manager(debatechat_entity $debatechat) {
        return new capability_manager(
            $debatechat,
            $this->legacydatamapperfactory->get_debatechat_data_mapper(),
